...
import type{RegistryParams,LoginPost,LoginResponse,registerResponse, RegistryPost} from '@/types/formSubmit'
import { useUsersStore } from "@/store/user";

export const userApi = {
  login: async (params: LoginPost, timeout_ = 5000) => {
  ...
  register: async (params: RegistryPost, timeout_ = 5000) => {
